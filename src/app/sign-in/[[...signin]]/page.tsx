      ...
      <div className="relative z-10 w-full max-w-[500px] px-4 mx-auto py-8">
        ...
        <div className="w-full fade-in-up">
          ...
          <div className="w-full bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl shadow-2xl border border-blue-500/20 relative overflow-hidden p-6 md:p-8">
            ...
            {/* Enhanced Clerk SignIn with correct alignment */}
            <div className="flex justify-center w-full">
              <SignIn
                forceRedirectUrl={"/auth/signin-complete"}
                appearance={{
                  elements: {
                    formButtonPrimary:
                    ...
                    formFieldInput:
                      "bg-white/50 dark:bg-gray-800/70 border border-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring focus:ring-blue-500/20 dark:text-white rounded-lg transition-all duration-200",
                    footerActionLink:
                      "text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline-offset-2 font-medium",
                    ...
                    dividerText:
                      "text-gray-500 dark:text-gray-400 bg-white/50 dark:bg-gray-900/60 px-3",
                    formFieldAction:
